    ...
    <body id="page-top" class="index">
        ...
        <header>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <img class="img-responsive" src="img/profile.png" alt=""> (Without the moustache, and with blonde hair etc. You get it...)
                ...
                <div class="container">
                    <div class="row">
                        <div class="footer-col col-md-4">
                            <h3>Location</h3>
                            <p>Cardboard Box 9001
                                <br>Channel Tunnel, UK CT17</p>
                        </div>
                        <div class="footer-col col-md-4">
